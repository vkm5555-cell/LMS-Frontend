...
// Course categories will be fetched from API
const courseModes = [
...
export default function AddCourse() {
  ...
  // Set user_id to current user from localStorage and fetch course categories
  useEffect(() => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const apiBaseUrl = import.meta.env.VITE_API_BASE_URL;
      const token = localStorage.getItem("token");
      // Send all fields and the image file in a single FormData POST to /courses
  ...
  return (
    <>
      <PageMeta title="Admin | Add Course" description="Add a new course to the LMS as an admin." />
